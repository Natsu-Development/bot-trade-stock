  ...
  theme: {
    extend: {
      colors: {
        ...
        'neon-bull-deep': 'var(--neon-bull-deep)',
        'neon-bear-deep': 'var(--neon-bear-deep)',
        'neon-cyan-deep': 'var(--neon-cyan-deep)',
        'neon-purple-dim': 'var(--neon-purple-dim)',
        'neon-amber-dim': 'var(--neon-amber-dim)',
        'neon-amber-soft': 'var(--neon-amber-soft)',
        'neon-bull-border': 'var(--neon-bull-border)',
        'neon-bear-border': 'var(--neon-bear-border)',
        'neon-amber-border': 'var(--neon-amber-border)',
        'neon-cyan-border': 'var(--neon-cyan-border)',
        'overlay-void': 'var(--overlay-void)',
      },
      fontFamily: {
